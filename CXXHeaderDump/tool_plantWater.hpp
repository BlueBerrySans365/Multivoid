#ifndef UE4SS_SDK_tool_plantWater_HPP
#define UE4SS_SDK_tool_plantWater_HPP

class Atool_plantWater_C : public AtoolObject_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0530 (size: 0x8)
    float Water;                                                                      // 0x0538 (size: 0x4)
    ...
    void ExecuteUbergraph_tool_plantWater(int32 EntryPoint);
}; // Size: 0x53C
