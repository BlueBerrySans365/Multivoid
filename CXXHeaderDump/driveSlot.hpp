#ifndef UE4SS_SDK_driveSlot_HPP
#define UE4SS_SDK_driveSlot_HPP

class AdriveSlot_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UStaticMeshComponent* buttonMesh2;                                          // 0x0228 (size: 0x8)
    class UAudioComponent* audio_out;                                                 // 0x0230 (size: 0x8)
    class UAudioComponent* audio_in;                                                  // 0x0238 (size: 0x8)
    class UBoxComponent* drivePort;                                                   // 0x0240 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0248 (size: 0x8)
    class Aprop_drive_C* drive;                                                       // 0x0250 (size: 0x8)
    FdriveSlot_CDriveIn driveIn;                                                      // 0x0258 (size: 0x10)
    void driveIn(class Aprop_drive_C* drive);
    FdriveSlot_CDriveOut driveOut;                                                    // 0x0268 (size: 0x10)
    void driveOut();
    bool isRecentlyDetached;                                                          // 0x0278 (size: 0x1)
    class AActor* overlapped;                                                         // 0x0280 (size: 0x8)
    ...
    void BndEvt__driveSlot_drivePort_play_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
    ...
    void putDriveIn(class AActor* overlapped);
    void drivePulledOut();
    void ReceiveTick(float DeltaSeconds);
    void ExecuteUbergraph_driveSlot(int32 EntryPoint);
    void driveOut__DelegateSignature();
    void driveIn__DelegateSignature(class Aprop_drive_C* drive);
}; // Size: 0x288
