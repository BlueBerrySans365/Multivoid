#ifndef UE4SS_SDK_wisp_g_HPP
#define UE4SS_SDK_wisp_g_HPP

class Awisp_g_C : public ACharacter
{
    ...
    float a_a_2E06FCD847244173BFA5E285F79AF188;                                       // 0x0510 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_2E06FCD847244173BFA5E285F79AF188; // 0x0514 (size: 0x1)
    class UTimelineComponent* A;                                                      // 0x0518 (size: 0x8)
    float ime;                                                                        // 0x0520 (size: 0x4)
    bool disappearing;                                                                // 0x0524 (size: 0x1)
    TArray<TEnumAsByte<EObjectTypeQuery>> obj;                                        // 0x0528 (size: 0x10)
    bool landed;                                                                      // 0x0538 (size: 0x1)
    FVector last;                                                                     // 0x053C (size: 0xC)
    class APawn* Pawn;                                                                // 0x0548 (size: 0x8)
    bool consume;                                                                     // 0x0550 (size: 0x1)
    FVector boxEx;                                                                    // 0x0554 (size: 0xC)
    FVector boxOr;                                                                    // 0x0560 (size: 0xC)
    ...
    void a__UpdateFunc();
    void OnFail_EEB92AE64DDD86468629A7B826088DD7(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_EEB92AE64DDD86468629A7B826088DD7(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
