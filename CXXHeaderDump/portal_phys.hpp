#ifndef UE4SS_SDK_portal_phys_HPP
#define UE4SS_SDK_portal_phys_HPP

class Aportal_phys_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UBoxComponent* wall_y-;                                                     // 0x0228 (size: 0x8)
    class UBoxComponent* wall_y+;                                                     // 0x0230 (size: 0x8)
    class UBoxComponent* wall_z-;                                                     // 0x0238 (size: 0x8)
    class UBoxComponent* wall_z+;                                                     // 0x0240 (size: 0x8)
    class UBillboardComponent* Billboard1;                                            // 0x0248 (size: 0x8)
    class UBoxComponent* outside;                                                     // 0x0250 (size: 0x8)
    class UBoxComponent* insides;                                                     // 0x0258 (size: 0x8)
    class UBillboardComponent* Billboard;                                             // 0x0260 (size: 0x8)
    class UChildActorComponent* ChildActor;                                           // 0x0268 (size: 0x8)
    class UArrowComponent* backward;                                                  // 0x0270 (size: 0x8)
    class UArrowComponent* Forward;                                                   // 0x0278 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0280 (size: 0x8)
    FName Key;                                                                        // 0x0288 (size: 0x8)
    class Aportal_phys_C* Out;                                                        // 0x0290 (size: 0x8)
    FName OutKey;                                                                     // 0x0298 (size: 0x8)
    FVector Size;                                                                     // 0x02A0 (size: 0xC)
    TArray<class AActor*> insideActors;                                               // 0x02B0 (size: 0x10)
    float off;                                                                        // 0x02C0 (size: 0x4)
    TArray<class UStaticMeshComponent*> Meshes;                                       // 0x02C8 (size: 0x10)
    TArray<class UStaticMeshComponent*> comps;                                        // 0x02D8 (size: 0x10)
    FVector Mesh Offset;                                                              // 0x02E8 (size: 0xC)
    FVector Mesh Scale;                                                               // 0x02F4 (size: 0xC)
    class UStaticMesh* Mesh;                                                          // 0x0300 (size: 0x8)
    Fportal_phys_CNewEventDispatcher_0 NewEventDispatcher_0;                          // 0x0308 (size: 0x10)
    void NewEventDispatcher_0();
    float renderDistance;                                                             // 0x0318 (size: 0x4)
    bool useBeginPlayEnable;                                                          // 0x031C (size: 0x1)
    bool beginPlayEnable;                                                             // 0x031D (size: 0x1)
    float MaxViewDistanceOverride;                                                    // 0x0320 (size: 0x4)
    class AmainGamemode_C* GameMode;                                                  // 0x0328 (size: 0x8)
    ...
    void getParentVelocity(FVector& Linear, FVector& angular);
    FTransform noScale(const FTransform& InTransform);
    void rebuild();
    ...
    void BndEvt__insides_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
