#ifndef UE4SS_SDK_grime_oil_HPP
#define UE4SS_SDK_grime_oil_HPP

class Agrime_oil_C : public Agrime_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0280 (size: 0x8)
    class UStaticMeshComponent* cube_0;                                               // 0x0288 (size: 0x8)
    ...
    void ExecuteUbergraph_grime_oil(int32 EntryPoint);
}; // Size: 0x290
