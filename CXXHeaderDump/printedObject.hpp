#ifndef UE4SS_SDK_printedObject_HPP
#define UE4SS_SDK_printedObject_HPP

class AprintedObject_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class Ucomp_physicsImpact_C* physicsImpact;                                       // 0x0228 (size: 0x8)
    class UProceduralMeshComponent* ProceduralMesh;                                   // 0x0230 (size: 0x8)
    FString Name;                                                                     // 0x0238 (size: 0x10)
    class UMaterialInstanceDynamic* dynmat;                                           // 0x0248 (size: 0x8)
    FName Key;                                                                        // 0x0250 (size: 0x8)
    bool isValidModel;                                                                // 0x0258 (size: 0x1)
    Fstruct_multisectionCustomMesh multisectionData;                                  // 0x0260 (size: 0x128)
    bool Loaded;                                                                      // 0x0388 (size: 0x1)
    class UPointLightComponent* LightComponent;                                       // 0x0390 (size: 0x8)
    class AmainGamemode_C* GameMode;                                                  // 0x0398 (size: 0x8)
    int32 bites;                                                                      // 0x03A0 (size: 0x4)
    bool edible;                                                                      // 0x03A4 (size: 0x1)
    FVector localBoundingBox;                                                         // 0x03A8 (size: 0xC)
    bool toggleLight;                                                                 // 0x03B4 (size: 0x1)
    bool lightActive;                                                                 // 0x03B5 (size: 0x1)
    class UAudioComponent* audio_light;                                               // 0x03B8 (size: 0x8)
    TArray<FVector> collPoints;                                                       // 0x03C0 (size: 0x10)
    ...
    void loadFromPrinter(Fstruct_multisectionCustomMesh multisectionMesh);
