#ifndef UE4SS_SDK_actorChipPile_HPP
#define UE4SS_SDK_actorChipPile_HPP
...
class AactorChipPile_C : public AActor
{
    ...
    TArray<class AActor*> ignore;                                                     // 0x0240 (size: 0x10)
    bool spwnd;                                                                       // 0x0250 (size: 0x1)
    TSubclassOf<class AactorChipPile_C> pile;                                         // 0x0258 (size: 0x8)
    TSubclassOf<class Aprop_garbageClump_C> clump;                                    // 0x0260 (size: 0x8)
    class Ucomp_flammable_C* flameBase;                                               // 0x0268 (size: 0x8)
    float fireHealth;                                                                 // 0x0270 (size: 0x4)
    ...
    void turnToPile(FVector Velocity);
    void turnIntoScrap();
    ...
    void BndEvt__actorChipPile_collision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
