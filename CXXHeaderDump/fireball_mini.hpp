#ifndef UE4SS_SDK_fireball_mini_HPP
#define UE4SS_SDK_fireball_mini_HPP

class Afireball_mini_C : public AActor
{
    ...
    float fuel;                                                                       // 0x0270 (size: 0x4)
    TArray<TEnumAsByte<EObjectTypeQuery>> obj;                                        // 0x0278 (size: 0x10)
    TArray<class TSubclassOf<AActor>> Filter;                                         // 0x0288 (size: 0x10)
    ...
    void ExecuteUbergraph_fireball_mini(int32 EntryPoint);
}; // Size: 0x298
