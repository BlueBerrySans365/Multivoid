#ifndef UE4SS_SDK_sitBox_HPP
#define UE4SS_SDK_sitBox_HPP

class AsitBox_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0228 (size: 0x8)
    class UParticleSystemComponent* eff_sit;                                          // 0x0230 (size: 0x8)
    class UCapsuleComponent* Capsule;                                                 // 0x0238 (size: 0x8)
    class UArrowComponent* getOff;                                                    // 0x0240 (size: 0x8)
    class UBillboardComponent* B;                                                     // 0x0248 (size: 0x8)
    class UBillboardComponent* A;                                                     // 0x0250 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x0258 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0260 (size: 0x8)
    class Ucomp_sitting_C* sitting;                                                   // 0x0268 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0270 (size: 0x8)
    class Aprop_C* prop;                                                              // 0x0278 (size: 0x8)
    FVector Location;                                                                 // 0x0280 (size: 0xC)
    float getoffAngle;                                                                // 0x028C (size: 0x4)
    float Distance;                                                                   // 0x0290 (size: 0x4)
    bool enableIcon;                                                                  // 0x0294 (size: 0x1)
    ...
    void BndEvt__sitBox_Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
    void BndEvt__sitBox_Sphere_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex);
