#ifndef UE4SS_SDK_grime_coffee_HPP
#define UE4SS_SDK_grime_coffee_HPP

class Agrime_coffee_C : public Agrime_C
{
    ...
    void ExecuteUbergraph_grime_coffee(int32 EntryPoint);
}; // Size: 0x288
