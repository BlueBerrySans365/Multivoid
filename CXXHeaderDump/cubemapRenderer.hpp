#ifndef UE4SS_SDK_cubemapRenderer_HPP
#define UE4SS_SDK_cubemapRenderer_HPP

class AcubemapRenderer_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UArrowComponent* Z;                                                         // 0x0228 (size: 0x8)
    class UArrowComponent* Y;                                                         // 0x0230 (size: 0x8)
    class UArrowComponent* X;                                                         // 0x0238 (size: 0x8)
    class UStaticMeshComponent* cube;                                                 // 0x0240 (size: 0x8)
    class USceneCaptureComponentCube* SceneCaptureComponentCube;                      // 0x0248 (size: 0x8)
    ...
    void ExecuteUbergraph_cubemapRenderer(int32 EntryPoint);
}; // Size: 0x250
