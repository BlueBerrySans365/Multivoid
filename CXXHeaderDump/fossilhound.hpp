#ifndef UE4SS_SDK_fossilhound_HPP
#define UE4SS_SDK_fossilhound_HPP

class Afossilhound_C : public ACharacter
{
    ...
    class URadialForceComponent* RadialForce;                                         // 0x04E0 (size: 0x8)
    class USphereComponent* dmg;                                                      // 0x04E8 (size: 0x8)
    class Ucomp_radarPoint_C* radarPoint;                                             // 0x04F0 (size: 0x8)
    class UAudioComponent* miss1;                                                     // 0x04F8 (size: 0x8)
    class UAudioComponent* scr;                                                       // 0x0500 (size: 0x8)
    class UAudioComponent* Voice;                                                     // 0x0508 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0510 (size: 0x8)
    class UAudioComponent* miss;                                                      // 0x0518 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0520 (size: 0x8)
    class UPawnSensingComponent* PawnSensing;                                         // 0x0528 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x0530 (size: 0x8)
    FName Key;                                                                        // 0x0538 (size: 0x8)
    class Ufossilhound_Skeleton_AnimBlueprint_C* Anim;                                // 0x0540 (size: 0x8)
    class AActor* chase;                                                              // 0x0548 (size: 0x8)
    TArray<TEnumAsByte<EObjectTypeQuery>> obj;                                        // 0x0550 (size: 0x10)
    int32 Steps;                                                                      // 0x0560 (size: 0x4)
    bool rendered;                                                                    // 0x0564 (size: 0x1)
    TArray<FName> gibs;                                                               // 0x0568 (size: 0x10)
    float accDmg;                                                                     // 0x0578 (size: 0x4)
    float health;                                                                     // 0x057C (size: 0x4)
    TArray<TEnumAsByte<EObjectTypeQuery>> objs;                                       // 0x0580 (size: 0x10)
    bool deth;                                                                        // 0x0590 (size: 0x1)
    float maxHealth;                                                                  // 0x0594 (size: 0x4)
    bool inWater;                                                                     // 0x0598 (size: 0x1)
    bool digOut;                                                                      // 0x0599 (size: 0x1)
    float gibLifespan;                                                                // 0x059C (size: 0x4)
    ...
    void sort(class UObject* ObjectA, class UObject* ObjectB, bool& Result);
    void sensingObjects();
    void filterPawns(const class AActor* Object, bool& pass);
    bool biteZone(TArray<class AActor*>& OutActors);
    void OnFail_0E745DC84F3F253C61EE1CA07A3DC668(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_0E745DC84F3F253C61EE1CA07A3DC668(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnFail_8715C85644F7F13D378B8396504A9049(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_8715C85644F7F13D378B8396504A9049(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnNotifyEnd_93ABDF4F4ACEA571A02E1AAFF4084A64(FName NotifyName);
    void OnNotifyBegin_93ABDF4F4ACEA571A02E1AAFF4084A64(FName NotifyName);
    void OnInterrupted_93ABDF4F4ACEA571A02E1AAFF4084A64(FName NotifyName);
    void OnBlendOut_93ABDF4F4ACEA571A02E1AAFF4084A64(FName NotifyName);
    void OnCompleted_93ABDF4F4ACEA571A02E1AAFF4084A64(FName NotifyName);
    ...
    void regen();
    void senseObject(class AActor* InputPin);
    void senseTimer();
