#ifndef UE4SS_SDK_dirthole_HPP
#define UE4SS_SDK_dirthole_HPP

class Adirthole_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0228 (size: 0x8)
    class UAudioComponent* shovelDig_2;                                               // 0x0230 (size: 0x8)
    class UBillboardComponent* Billboard;                                             // 0x0238 (size: 0x8)
    class UStaticMeshComponent* hole;                                                 // 0x0240 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0248 (size: 0x8)
    class AActor* obj;                                                                // 0x0250 (size: 0x8)
    int32 matType;                                                                    // 0x0258 (size: 0x4)
    ...
    void filterItems(const class AActor* Object, bool& bLocked);
    void processBuriedItem(Fstruct_save InputPin, class Aprop_C* Actor, bool& return);
