#ifndef UE4SS_SDK_stepper_HPP
#define UE4SS_SDK_stepper_HPP

class Astepper_C : public ACharacter
{
    ...
    FName Key;                                                                        // 0x0518 (size: 0x8)
    bool walking;                                                                     // 0x0520 (size: 0x1)
    ...
    void setPoint();
    void stepOn();
    void OnFail_B31AF7A44B7A0CD51981ACA205B32EC5(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_B31AF7A44B7A0CD51981ACA205B32EC5(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
