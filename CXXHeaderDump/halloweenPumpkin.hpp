#ifndef UE4SS_SDK_halloweenPumpkin_HPP
#define UE4SS_SDK_halloweenPumpkin_HPP

class AhalloweenPumpkin_C : public AActor
{
    ...
    void ExecuteUbergraph_halloweenPumpkin(int32 EntryPoint);
}; // Size: 0x248
