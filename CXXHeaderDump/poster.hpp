#ifndef UE4SS_SDK_poster_HPP
#define UE4SS_SDK_poster_HPP

class Aposter_c : public Aactor_save_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0248 (size: 0x8)
    class UBoxComponent* coll;                                                        // 0x0250 (size: 0x8)
    class UDecalComponent* Decal;                                                     // 0x0258 (size: 0x8)
    int32 Type;                                                                       // 0x0260 (size: 0x4)
    int32 Index;                                                                      // 0x0264 (size: 0x4)
    class UMaterialInstanceDynamic* dynmat;                                           // 0x0268 (size: 0x8)
    FName Filename;                                                                   // 0x0270 (size: 0x8)
    bool Custom;                                                                      // 0x0278 (size: 0x1)
    TSubclassOf<class Aprop_poster_C> posterClass;                                    // 0x0280 (size: 0x8)
