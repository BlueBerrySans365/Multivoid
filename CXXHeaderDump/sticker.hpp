#ifndef UE4SS_SDK_sticker_HPP
#define UE4SS_SDK_sticker_HPP

class Asticker_C : public Aactor_save_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0248 (size: 0x8)
    class UStaticMeshComponent* Plane;                                                // 0x0250 (size: 0x8)
    class UBoxComponent* coll;                                                        // 0x0258 (size: 0x8)
    class UMaterialInstanceDynamic* dynmat;                                           // 0x0260 (size: 0x8)
    FString Name;                                                                     // 0x0268 (size: 0x10)
    FName AttachTo;                                                                   // 0x0278 (size: 0x8)
    class AActor* Actor;                                                              // 0x0280 (size: 0x8)
