...
class Aconveyor_turnR_2_C : public AActor
{
    ...
    FRotator rot;                                                                     // 0x0264 (size: 0xC)
    FRotator prev;                                                                    // 0x0270 (size: 0xC)
    bool dontCheck;                                                                   // 0x027C (size: 0x1)
    bool dir;                                                                         // 0x027D (size: 0x1)
    bool hasWall;                                                                     // 0x027E (size: 0x1)
