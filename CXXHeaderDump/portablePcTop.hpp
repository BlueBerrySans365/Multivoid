#ifndef UE4SS_SDK_portablePcTop_HPP
#define UE4SS_SDK_portablePcTop_HPP

class AportablePcTop_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UArrowComponent* CamLoc;                                                    // 0x0228 (size: 0x8)
    class UWidgetComponent* screen;                                                   // 0x0230 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0238 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0240 (size: 0x8)
    class Aprop_portablePc_C* laptopObject;                                           // 0x0248 (size: 0x8)
    ...
    void exitLaptop();
    void ExecuteUbergraph_portablePcTop(int32 EntryPoint);
}; // Size: 0x250
