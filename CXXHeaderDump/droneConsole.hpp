#ifndef UE4SS_SDK_droneConsole_HPP
#define UE4SS_SDK_droneConsole_HPP

class AdroneConsole_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UAudioComponent* audio_change;                                              // 0x0228 (size: 0x8)
    class UAudioComponent* audio_deny;                                                // 0x0230 (size: 0x8)
    class UAudioComponent* audio_accept;                                              // 0x0238 (size: 0x8)
    class UAudioComponent* audio_door;                                                // 0x0240 (size: 0x8)
    class UParticleSystemComponent* eff_blinklight3;                                  // 0x0248 (size: 0x8)
    class UBoxComponent* button_changeLeave;                                          // 0x0250 (size: 0x8)
    class UBoxComponent* button_call;                                                 // 0x0258 (size: 0x8)
    class UBoxComponent* button_door;                                                 // 0x0260 (size: 0x8)
    class UParticleSystemComponent* eff_blinklight2;                                  // 0x0268 (size: 0x8)
    class UStaticMeshComponent* door;                                                 // 0x0270 (size: 0x8)
    class UBillboardComponent* doorAx;                                                // 0x0278 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0280 (size: 0x8)
    float a_a_A5238F134FEEE97667C295BEC6B473C1;                                       // 0x0288 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_A5238F134FEEE97667C295BEC6B473C1; // 0x028C (size: 0x1)
    class UTimelineComponent* A;                                                      // 0x0290 (size: 0x8)
    bool opened;                                                                      // 0x0298 (size: 0x1)
    class Adrone_C* drone;                                                            // 0x02A0 (size: 0x8)
    class AmainGamemode_C* GameMode;                                                  // 0x02A8 (size: 0x8)
    bool lookAtDoor;                                                                  // 0x02B0 (size: 0x1)
    bool lookatKeyboard;                                                              // 0x02B1 (size: 0x1)
    FString useKey;                                                                   // 0x02B8 (size: 0x10)
    bool lookat_changeTime;                                                           // 0x02C8 (size: 0x1)
