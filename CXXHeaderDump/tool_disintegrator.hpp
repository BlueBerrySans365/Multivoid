#ifndef UE4SS_SDK_tool_disintegrator_HPP
#define UE4SS_SDK_tool_disintegrator_HPP

class Atool_disintegrator_C : public AtoolObject_C
{
    ...
    void ExecuteUbergraph_tool_disintegrator(int32 EntryPoint);
}; // Size: 0x550
