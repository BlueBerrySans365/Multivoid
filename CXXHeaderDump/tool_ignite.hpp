#ifndef UE4SS_SDK_tool_ignite_HPP
#define UE4SS_SDK_tool_ignite_HPP

class Atool_ignite_C : public AtoolObject_C
{
    ...
    void ExecuteUbergraph_tool_ignite(int32 EntryPoint);
}; // Size: 0x53C
