#ifndef UE4SS_SDK_wisp_o_HPP
#define UE4SS_SDK_wisp_o_HPP

class Awisp_o_C : public ACharacter
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x04C0 (size: 0x8)
    class USphereComponent* Sphere1;                                                  // 0x04C8 (size: 0x8)
    class UPawnSensingComponent* PawnSensing;                                         // 0x04D0 (size: 0x8)
    class USphereComponent* dooropener;                                               // 0x04D8 (size: 0x8)
    class UAudioComponent* gravigun_object_hold_loop;                                 // 0x04E0 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x04E8 (size: 0x8)
    class Ucomp_radarPoint_C* radarPoint;                                             // 0x04F0 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x04F8 (size: 0x8)
    class UBillboardComponent* arg;                                                   // 0x0500 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0508 (size: 0x8)
    class UParticleSystemComponent* eff_wisp;                                         // 0x0510 (size: 0x8)
    float a_a_F1AACFBB43609AAE1D621EA5468BBC54;                                       // 0x0518 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_F1AACFBB43609AAE1D621EA5468BBC54; // 0x051C (size: 0x1)
    class UTimelineComponent* A;                                                      // 0x0520 (size: 0x8)
    float ime;                                                                        // 0x0528 (size: 0x4)
    bool disappearing;                                                                // 0x052C (size: 0x1)
    TArray<TEnumAsByte<EObjectTypeQuery>> obj;                                        // 0x0530 (size: 0x10)
    bool landed;                                                                      // 0x0540 (size: 0x1)
    FVector last;                                                                     // 0x0544 (size: 0xC)
    class APawn* Pawn;                                                                // 0x0550 (size: 0x8)
    bool consume;                                                                     // 0x0558 (size: 0x1)
    ...
    void a__UpdateFunc();
    void OnFail_B8AFE3DE40F139C1388C2480DCB735C7(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_B8AFE3DE40F139C1388C2480DCB735C7(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    ...
    void BndEvt__wisp_p_Sphere1_K2Node_ComponentBoundEvent_3_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
    void ExecuteUbergraph_wisp_o(int32 EntryPoint);
}; // Size: 0x559
