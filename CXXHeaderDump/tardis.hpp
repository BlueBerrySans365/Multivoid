#ifndef UE4SS_SDK_tardis_HPP
#define UE4SS_SDK_tardis_HPP

class Atardis_C : public AActor
{
    ...
    class UParticleSystemComponent* ligh;                                             // 0x0240 (size: 0x8)
    class UAudioComponent* tardis_spawn;                                              // 0x0248 (size: 0x8)
    class UAudioComponent* tardis_despawn;                                            // 0x0250 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0258 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0260 (size: 0x8)
    float a_NewTrack_0_180E0F334655F141F9C735976D48A3D0;                              // 0x0268 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_180E0F334655F141F9C735976D48A3D0; // 0x026C (size: 0x1)
    class UTimelineComponent* A;                                                      // 0x0270 (size: 0x8)
    class UMaterialInstanceDynamic* dynmat;                                           // 0x0278 (size: 0x8)
    bool appeared;                                                                    // 0x0280 (size: 0x1)
    float Delay;                                                                      // 0x0284 (size: 0x4)
    ...
    void BndEvt__tardis_Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
