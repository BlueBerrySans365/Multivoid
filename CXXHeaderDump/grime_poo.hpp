#ifndef UE4SS_SDK_grime_poo_HPP
#define UE4SS_SDK_grime_poo_HPP

class Agrime_poo_C : public Agrime_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0280 (size: 0x8)
    class UAudioComponent* fliesSlow_Cue;                                             // 0x0288 (size: 0x8)
    class UParticleSystemComponent* eff_spoiled;                                      // 0x0290 (size: 0x8)
    ...
    void ExecuteUbergraph_grime_poo(int32 EntryPoint);
}; // Size: 0x298
