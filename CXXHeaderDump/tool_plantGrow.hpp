#ifndef UE4SS_SDK_tool_plantGrow_HPP
#define UE4SS_SDK_tool_plantGrow_HPP

class Atool_plantGrow_C : public AtoolObject_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0530 (size: 0x8)
    float grow;                                                                       // 0x0538 (size: 0x4)
    ...
    void ExecuteUbergraph_tool_plantGrow(int32 EntryPoint);
}; // Size: 0x53C
