#ifndef UE4SS_SDK_tool_chromium_HPP
#define UE4SS_SDK_tool_chromium_HPP

class Atool_chromium_C : public AtoolObject_C
{
    ...
    void ExecuteUbergraph_tool_chromium(int32 EntryPoint);
}; // Size: 0x550
