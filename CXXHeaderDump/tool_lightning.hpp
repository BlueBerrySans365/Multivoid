#ifndef UE4SS_SDK_tool_lightning_HPP
#define UE4SS_SDK_tool_lightning_HPP

class Atool_lightning_C : public AtoolObject_C
{
    ...
    void ExecuteUbergraph_tool_lightning(int32 EntryPoint);
}; // Size: 0x550
