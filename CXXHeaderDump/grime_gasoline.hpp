#ifndef UE4SS_SDK_grime_gasoline_HPP
#define UE4SS_SDK_grime_gasoline_HPP

class Agrime_gasoline_C : public Agrime_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0280 (size: 0x8)
    class Ucomp_flammable_C* flameBase;                                               // 0x0288 (size: 0x8)
    float fuel;                                                                       // 0x0290 (size: 0x4)
    ...
    void ExecuteUbergraph_grime_gasoline(int32 EntryPoint);
}; // Size: 0x294
