#ifndef UE4SS_SDK_rope_broken_HPP
#define UE4SS_SDK_rope_broken_HPP

class Arope_broken_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class USphereComponent* B;                                                        // 0x0228 (size: 0x8)
    class UCableComponent* Cable;                                                     // 0x0230 (size: 0x8)
    class UArrowComponent* A;                                                         // 0x0238 (size: 0x8)
    class AActor* actor_a;                                                            // 0x0240 (size: 0x8)
    float dist;                                                                       // 0x0248 (size: 0x4)
    class UPrimitiveComponent* component_A;                                           // 0x0250 (size: 0x8)
    class UPrimitiveComponent* component_B;                                           // 0x0258 (size: 0x8)
    class USphereComponent* phys;                                                     // 0x0260 (size: 0x8)
    float maxDist;                                                                    // 0x0268 (size: 0x4)
    ...
    void setLength();
    void attach_a(class AActor* Actor, FVector loc_A, FVector loc_B, float dist);
