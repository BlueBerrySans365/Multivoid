#ifndef UE4SS_SDK_wisp_blu_HPP
#define UE4SS_SDK_wisp_blu_HPP

class Awisp_blu_C : public ACharacter
{
    ...
    class USphereComponent* agravSphere;                                              // 0x04D8 (size: 0x8)
    ...
    float a_a_50C6CF2542B4E11CA28F81B02D4E443B;                                       // 0x0508 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_50C6CF2542B4E11CA28F81B02D4E443B; // 0x050C (size: 0x1)
    ...
    class APawn* Pawn;                                                                // 0x0540 (size: 0x8)
    bool consume;                                                                     // 0x0548 (size: 0x1)
    TArray<class AActor*> objs;                                                       // 0x0550 (size: 0x10)
    ...
    void a__UpdateFunc();
    void OnFail_DFDA4EBB4B7ACE8B399BA387C4523C25(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_DFDA4EBB4B7ACE8B399BA387C4523C25(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void digUp();
    void unhook();
    ...
    void BndEvt__wisp_blu_agravSphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
