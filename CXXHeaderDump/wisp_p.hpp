#ifndef UE4SS_SDK_wisp_p_HPP
#define UE4SS_SDK_wisp_p_HPP

class Awisp_p_C : public ACharacter
{
    ...
    float a_a_3996E42144903B1F4648D6929749859B;                                       // 0x0518 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_3996E42144903B1F4648D6929749859B; // 0x051C (size: 0x1)
    ...
    void a__UpdateFunc();
    void OnFail_5964CA0C498861B5278421A25658D22C(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_5964CA0C498861B5278421A25658D22C(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
