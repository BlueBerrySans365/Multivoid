...
class Acandle_C : public Aactor_save_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0248 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0250 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0258 (size: 0x8)
    class UStaticMeshComponent* flame;                                                // 0x0260 (size: 0x8)
    class UStaticMeshComponent* candle;                                               // 0x0268 (size: 0x8)
    int32 Type;                                                                       // 0x0270 (size: 0x4)
    FName attach_key;                                                                 // 0x0274 (size: 0x8)
    class AActor* attach_object;                                                      // 0x0280 (size: 0x8)
    ...
    void attach(class AActor* attach_object);
    void Init();
