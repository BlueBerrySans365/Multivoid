#ifndef UE4SS_SDK_grime_blood2_HPP
#define UE4SS_SDK_grime_blood2_HPP

class Agrime_blood2_C : public Agrime_C
{
    ...
    void ExecuteUbergraph_grime_blood2(int32 EntryPoint);
}; // Size: 0x288
