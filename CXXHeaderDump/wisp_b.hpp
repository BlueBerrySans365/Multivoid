#ifndef UE4SS_SDK_wisp_b_HPP
#define UE4SS_SDK_wisp_b_HPP

class Awisp_b_C : public ACharacter
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x04C0 (size: 0x8)
    class UParticleSystemComponent* eff_wisp;                                         // 0x04C8 (size: 0x8)
    class UPhysicsConstraintComponent* PhysicsConstraint;                             // 0x04D0 (size: 0x8)
    class UStaticMeshComponent* coll;                                                 // 0x04D8 (size: 0x8)
    class UStaticMeshComponent* Base;                                                 // 0x04E0 (size: 0x8)
    class Ucomp_paranormal_C* pnormal;                                                // 0x04E8 (size: 0x8)
    class UAudioComponent* audio1;                                                    // 0x04F0 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x04F8 (size: 0x8)
    class Ucomp_radarPoint_C* radarPoint;                                             // 0x0500 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x0508 (size: 0x8)
    class UBillboardComponent* arg;                                                   // 0x0510 (size: 0x8)
    class UPointLightComponent* PointLight;                                           // 0x0518 (size: 0x8)
    float a_a_EFD38E2C4F57FED0AA706CB80FA79380;                                       // 0x0520 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_EFD38E2C4F57FED0AA706CB80FA79380; // 0x0524 (size: 0x1)
    ...
    void a__UpdateFunc();
    void OnFail_DEFB4DE441E9C21ECE835CA322E706B9(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_DEFB4DE441E9C21ECE835CA322E706B9(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
