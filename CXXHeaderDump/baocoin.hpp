#ifndef UE4SS_SDK_baocoin_HPP
#define UE4SS_SDK_baocoin_HPP

class Abaocoin_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class USphereComponent* collect;                                                  // 0x0228 (size: 0x8)
    class UStaticMeshComponent* baocoin;                                              // 0x0230 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0238 (size: 0x8)
    int32 Points;                                                                     // 0x0240 (size: 0x4)
    FVector V;                                                                        // 0x0244 (size: 0xC)
    FTimerHandle blink_timerHandle;                                                   // 0x0250 (size: 0x8)
    ...
    void BndEvt__baocoin_Sphere_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit);
    void ReceiveBeginPlay();
    void BndEvt__baocoin_collect_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
    void timerBlink();
