#ifndef UE4SS_SDK_npc_angryErieFlesh_HPP
#define UE4SS_SDK_npc_angryErieFlesh_HPP

class Anpc_angryErieFlesh_C : public ACharacter
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x04C0 (size: 0x8)
    class UAudioComponent* aaa_a_eee_e;                                               // 0x04C8 (size: 0x8)
    class UAudioComponent* audio_pain;                                                // 0x04D0 (size: 0x8)
    class Ucomp_radarPoint_C* comp_radarPoint;                                        // 0x04D8 (size: 0x8)
    class UPostProcessComponent* PostProcess;                                         // 0x04E0 (size: 0x8)
    class UAudioComponent* audio_breathing;                                           // 0x04E8 (size: 0x8)
    class UBillboardComponent* lastLocChase;                                          // 0x04F0 (size: 0x8)
    class UAudioComponent* Audio5;                                                    // 0x04F8 (size: 0x8)
    class UAudioComponent* Audio4;                                                    // 0x0500 (size: 0x8)
    class UAudioComponent* audio3;                                                    // 0x0508 (size: 0x8)
    class UAudioComponent* audio2;                                                    // 0x0510 (size: 0x8)
    class UAudioComponent* audio1;                                                    // 0x0518 (size: 0x8)
    class UParticleSystemComponent* ParticleSystem;                                   // 0x0520 (size: 0x8)
    class UInstancedStaticMeshComponent* InstancedStaticMesh;                         // 0x0528 (size: 0x8)
    class UPhysicsThrusterComponent* PhysicsThruster;                                 // 0x0530 (size: 0x8)
    class USphereComponent* B;                                                        // 0x0538 (size: 0x8)
    class UStaticMeshComponent* A;                                                    // 0x0540 (size: 0x8)
    class UPhysicsConstraintComponent* PhysicsConstraint;                             // 0x0548 (size: 0x8)
    int32 snd;                                                                        // 0x0550 (size: 0x4)
    bool kill;                                                                        // 0x0554 (size: 0x1)
    float spd;                                                                        // 0x0558 (size: 0x4)
    FVector lastSpawn;                                                                // 0x055C (size: 0xC)
    class Aprop_microwave_C* microwaveDestroy;                                        // 0x0568 (size: 0x8)
    bool NewVar_0;                                                                    // 0x0570 (size: 0x1)
    float time2;                                                                      // 0x0574 (size: 0x4)
    class UMaterialInstanceDynamic* dynmat_dizzy;                                     // 0x0578 (size: 0x8)
    bool launchArtillery;                                                             // 0x0580 (size: 0x1)
    int32 Segments;                                                                   // 0x0584 (size: 0x4)
    ...
    void getClosest(FVector closestTo, FVector& Location, bool& return);
    void setStart();
    void UserConstructionScript();
    void OnFail_BEAB0954439C324DE7B781A31D8FEB18(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_BEAB0954439C324DE7B781A31D8FEB18(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    ...
    void ExecuteUbergraph_npc_angryErieFlesh(int32 EntryPoint);
}; // Size: 0x588
