#ifndef UE4SS_SDK_tool_garbageSpawner_HPP
#define UE4SS_SDK_tool_garbageSpawner_HPP

class Atool_garbageSpawner_C : public AtoolObject_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0530 (size: 0x8)
    TEnumAsByte<enum_chipPileType::Type> chip_type;                                   // 0x0538 (size: 0x1)
    ...
    void ExecuteUbergraph_tool_garbageSpawner(int32 EntryPoint);
}; // Size: 0x539
