#ifndef UE4SS_SDK_cockroachMaster_HPP
#define UE4SS_SDK_cockroachMaster_HPP

class AcockroachMaster_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0228 (size: 0x8)
    int32 Count;                                                                      // 0x0230 (size: 0x4)
    TArray<class UStaticMeshComponent*> roaches;                                      // 0x0238 (size: 0x10)
    class UStaticMeshComponent* Current;                                              // 0x0248 (size: 0x8)
    FVector Loc;                                                                      // 0x0250 (size: 0xC)
    FVector Forward;                                                                  // 0x025C (size: 0xC)
    FVector Right;                                                                    // 0x0268 (size: 0xC)
    FVector Up;                                                                       // 0x0274 (size: 0xC)
    int32 maxAmount;                                                                  // 0x0280 (size: 0x4)
    FVector Target;                                                                   // 0x0284 (size: 0xC)
    FVector Size;                                                                     // 0x0290 (size: 0xC)
    TArray<TEnumAsByte<EObjectTypeQuery>> props;                                      // 0x02A0 (size: 0x10)
    FVector spawnBox;                                                                 // 0x02B0 (size: 0xC)
    bool doEat;                                                                       // 0x02BC (size: 0x1)
    FVector Escape;                                                                   // 0x02C0 (size: 0xC)
    TArray<class UPhysicalMaterial*> bannedMats;                                      // 0x02D0 (size: 0x10)
    int32 I;                                                                          // 0x02E0 (size: 0x4)
    class AmainGamemode_C* GameMode;                                                  // 0x02E8 (size: 0x8)
    int32 currentIndex;                                                               // 0x02F0 (size: 0x4)
    ...
    void calc();
    void foodRoachSpawn();
    void tryCrush(FVector Loc, class UPrimitiveComponent* Object);
    void checkRoof();
    void dedt(const FHitResult& Hit);
    void deleteRoach(int32 IndexToRemove, bool crush);
    void updCurrent();
    void upd();
    void addRoach(FVector Location, FVector Size, bool bypassCheck);
