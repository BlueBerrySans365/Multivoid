#ifndef UE4SS_SDK_locker_HPP
#define UE4SS_SDK_locker_HPP

class Alocker_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class UStaticMeshComponent* stair;                                                // 0x0228 (size: 0x8)
    class UStaticMeshComponent* door;                                                 // 0x0230 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x0238 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0240 (size: 0x8)
    class UArrowComponent* Axis;                                                      // 0x0248 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0250 (size: 0x8)
    class USceneComponent* DefaultSceneRoot;                                          // 0x0258 (size: 0x8)
    float a_a_80ED94194D3688F88DC22A9C1546EC4C;                                       // 0x0260 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_80ED94194D3688F88DC22A9C1546EC4C; // 0x0264 (size: 0x1)
    class UTimelineComponent* A;                                                      // 0x0268 (size: 0x8)
    bool opened;                                                                      // 0x0270 (size: 0x1)
    bool head;                                                                        // 0x0271 (size: 0x1)
    int32 blockedBy;                                                                  // 0x0274 (size: 0x4)
    bool debugPeek;                                                                   // 0x0278 (size: 0x1)
    bool noMeat;                                                                      // 0x0279 (size: 0x1)
    class AActor* triggerOnOpen;                                                      // 0x0280 (size: 0x8)
    FName triggerKey;                                                                 // 0x0288 (size: 0x8)
    class AmainGamemode_C* GameMode;                                                  // 0x0290 (size: 0x8)
    TArray<class Aprop_plankLockLocker_C*> BlockedbyPlanks;                           // 0x0298 (size: 0x10)
    TArray<FName> BlockedbyPlanks_Keys;                                               // 0x02A8 (size: 0x10)
