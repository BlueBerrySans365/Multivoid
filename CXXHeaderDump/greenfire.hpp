#ifndef UE4SS_SDK_greenfire_HPP
#define UE4SS_SDK_greenfire_HPP

class Agreenfire_C : public AActor
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0220 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x0228 (size: 0x8)
    class UCapsuleComponent* coll;                                                    // 0x0230 (size: 0x8)
    ...
    float activeDistance;                                                             // 0x0268 (size: 0x4)
    float influence;                                                                  // 0x026C (size: 0x4)
    int32 exts;                                                                       // 0x0270 (size: 0x4)
    class AgreenFireSpawner_C* spawner;                                               // 0x0278 (size: 0x8)
