#ifndef UE4SS_SDK_wisp_bl_HPP
#define UE4SS_SDK_wisp_bl_HPP

class Awisp_bl_C : public ACharacter
{
    ...
    float a_a_CAA2E7024BB32003D2E5D995CDEA0756;                                       // 0x0508 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> a__Direction_CAA2E7024BB32003D2E5D995CDEA0756; // 0x050C (size: 0x1)
    ...
    void a__UpdateFunc();
    void OnFail_720EE9704965462DFC8CF6B39F211C21(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
    void OnSuccess_720EE9704965462DFC8CF6B39F211C21(TEnumAsByte<EPathFollowingResult::Type> MovementResult);
